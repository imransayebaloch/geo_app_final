...
class ImageScreen extends StatefulWidget {
  ...
  int id,secondid;
  ImageScreen({ Key key,this.id, this.department, this.selectedCoordinat,this.secondid,this.secondname,this.collectcor }):super(key: key );
...
class _MainPageState extends State<ImageScreen> {
  ...
  void getHttp() async {
  //  try {
      http.Response response = await http.get('https://raw.githubusercontent.com/imransayebaloch/QDA-question/main/myAPI' );
  ...
  Widget _DecideImageView(){
    if( imageFile == null) {
      ...
      child:    Padding(
            ...
            child: Text('No image selected , please tap on \n    camera button insert an image' , style: TextStyle(fontWeight: FontWeight.bold),),
          )
      );
